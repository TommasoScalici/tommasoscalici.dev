...
export const musicReleases: MusicRelease[] = [
    {
        ...
        links: {
            ...
            youtube:
                'https://music.youtube.com/playlist?list=OLAK5uy_lVFpqujENo2g2mqThSzltKzgV-k4gE1hM',
    ...
    },
    {
        ...
        links: {
            ...
            youtube:
                'https://music.youtube.com/playlist?list=OLAK5uy_nwemOas8nlbFcvH7MEUUc2Qpk3p1O45QE',
