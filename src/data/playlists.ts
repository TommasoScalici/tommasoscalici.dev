...
export const playlistsData: Record<string, Playlist[]> = {
    en: [
        ...
        },
        {
            title: 'Modern Prog ⚡',
            description:
                'The best Modern Instrumental Progressive Metal. Djent, Math Rock & Heavy Riffs.',
        ...
        },
        {
            title: 'Heavy Riffs 🎸',
            description:
                'A solid collection of the best Heavy Riffs from Hard Rock, Metal & Alternative.',
    ...
    it: [
        ...
        },
        {
            title: 'Modern Prog ⚡',
            description:
                'Il meglio del Progressive Metal Strumentale Moderno. Djent, Math Rock & Riff Pesanti.',
            coverImage: progCover,
            spotifyId: '32xYNI24QWMWfSgG1xZgjI',
        ...
        },
        {
            title: 'Heavy Riffs 🎸',
            description:
                'Una solida raccolta dei migliori Riff Pesanti dal Hard Rock, Metal & Alternative.',
            coverImage: heavyRiffsCover,
            spotifyId: '49NveLmBkE159Zt6g0Novv',
            genre: 'Hard Rock / Metal',
        },
