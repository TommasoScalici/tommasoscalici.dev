...
export const ui = {
    en: {
        ...
        'nav.submitMusic': 'Submit your music!',
        ...
        'aria.viewSource': 'View Source Code',
        'aria.viewPlayStore': 'View on Google Play',
        'aria.viewProject': 'View Project Page',
        'aria.switchLanguage': 'Switch Language',
        'aria.cookieSettings': 'Cookie Settings',
        'aria.menu': 'Menu',
        'aria.toggleTheme': 'Toggle Theme',
        'aria.scrollToProjects': 'Scroll to projects',
        'aria.close': 'Close',
        'aria.musicPlatforms': 'Music Platforms',
        'aria.moreSocials': 'More Socials',
    },
    it: {
        'nav.home': 'Home',
        'nav.about': 'Chi Sono',
        ...
        'nav.submitMusic': 'Invia la tua musica!',
        ...
        'aria.viewSource': 'Visualizza Codice Sorgente',
        'aria.viewPlayStore': 'Visualizza su Google Play',
        'aria.viewProject': 'Visualizza Pagina Progetto',
        'aria.switchLanguage': 'Cambia Lingua',
        'aria.cookieSettings': 'Impostazioni Cookie',
        'aria.menu': 'Menu',
        'aria.toggleTheme': 'Cambia Tema',
        'aria.scrollToProjects': 'Scorri ai progetti',
        'aria.close': 'Chiudi',
        'aria.musicPlatforms': 'Piattaforme Musicali',
        'aria.moreSocials': 'Altri Social',
    },
} as const;
